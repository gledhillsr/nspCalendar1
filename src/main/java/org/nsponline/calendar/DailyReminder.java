...
/* Creates a new instance of reminder */
  ...
  public DailyReminder(String[] args, SessionData sessionData) {
    if (args.length != 1) {
...
//    }
  ...
  private static GregorianCalendar setupDate(int daysAhead) {
...
//System.out.println("dayOfWeek="+dayOfWeek+" ("+szDay[dayOfWeek]+")");
  ...
  private Vector<String> getPatrollersWhoHaveAssignment(Assignments assignment) {
    Vector<String> emailTo = new Vector<String>();
    emailTo.clear();
...
//emailTo.add("Steve@Gledhills.com");
  ...
  public static void main(String[] args) {
    ...
    new DailyReminder(args, sessionData);
  }
