...
/**
 * 1) Override the day shift template (add shift, change shift, delete shift, change event name for this day)
 * 2) Make mass changes to the day shift
 * 3) Delete the template for the day (including all assignments), and restore default template
 *
...
public class InnerChangeSingleDayShift extends ResourceBase {
  ...
  public InnerChangeSingleDayShift(HttpServletRequest request, HttpServletResponse response, Logger LOG) throws IOException {
