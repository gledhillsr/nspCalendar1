...
public class OuterRefresherTraining extends ResourceBase {
  ...
  private void printBody(String IDOfEditor) {
    ...
    String siteUrl = "<font size =\"2\" color=\"red\" face=verdana,arial><A href='http://gledhills.com/Brighton/training/index.php?id=" + IDOfEditor + "' target='_blank'><b>2021 Brighton Ski Patrol Refresher</b></a></font>";
