...
//      editInfo        = (Purpose != null && Purpose.equals("EditInfo"));
  ...
  public int readData(String readID, SessionData sessionData) {
    ...
    if (debug) {
      System.out.println("in UpdateInfo, IDOfEditor" + IDOfEditor + " resort=" + resort);
    }
    if (IDOfEditor.equals(PatrolData.backDoorUser)) {
      editor = null;
    ...
    if (debug) {
      System.out.println("in UpdateInfo, editor" + editor + " resort=" + resort);
    }
...
//            editorIsDirector = false;
    ...
    if (debug) {
      System.out.println("in UpdateInfo, returning from ReadData, resort=" + resort);
    }
    return 1;
  } //end ReadData
